        ...
        return (
            <div>
                ...
                <Flex className="row-scale">
                    ...
                    <VoteCard card={VoteCardEnum.C1} renderForMobile={this.props.renderForMobile}/>
                    <VoteCard card={VoteCardEnum.C3} renderForMobile={this.props.renderForMobile}/>
                    <VoteCard card={VoteCardEnum.C5} renderForMobile={this.props.renderForMobile}/>
                    <VoteCard card={VoteCardEnum.C8} renderForMobile={this.props.renderForMobile}/>
                    <VoteCard card={VoteCardEnum.C13} renderForMobile={this.props.renderForMobile}/>
                </Flex>
                <Flex className="row-scale">
                    <Flex className="equal-width">
